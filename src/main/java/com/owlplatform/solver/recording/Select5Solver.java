 ...
 * @author Robert Moore
 */
public class Select5Solver implements ConnectionListener, SampleListener,
		Runnable {
	...
	public static void main(String[] args) {
		...
		Select5Solver client = new Select5Solver();
	...
	protected SubscriptionRequestRule[] generateRequestRules() {
		...
		Transmitter[] txers = new Transmitter[5];
		txers[0] = new Transmitter(2573);
		txers[1] = new Transmitter(2574);
		txers[2] = new Transmitter(2575);
		txers[3] = new Transmitter(2576);
		txers[4] = new Transmitter(2577);
		rules[0].setTransmitters(txers);
